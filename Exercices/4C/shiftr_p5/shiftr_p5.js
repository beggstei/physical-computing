...
// MQTT client details:
let broker = {
  hostname: 'b3n14m1negg5te1n.cloud.shiftr.io',
  port: 443
 };
...
let creds = {
  clientID: 'p5',
  userName: 'b3n14m1negg5te1n',
  password: 'YlDpbrYsvqBZNgaR'
};
...
let topicSliderValue = 'sliderValue';
...
function draw() {
  ...
  */
  sendMqttMessage(sliderValue, topicDiameter);
